...
public interface IQueries
{
    ...
    Task<IEnumerable<Schema.FlatArticle>> GetExactPriceByPpLAsc(IEnumerable<Schema.FlatArticle> dta, int price,
        CancellationToken ct = default);

    Task<IEnumerable<Schema.FlatArticle>> GetMostBottles(IEnumerable<Schema.FlatArticle> dta,
        CancellationToken ct = default);
